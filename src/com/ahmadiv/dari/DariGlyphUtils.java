...
public class DariGlyphUtils {
        ...
        public static String reshapeText(String input, boolean reshape){
            if(!reshape)
            	return input;
        	if (input != null) {
                                ...
                                result.append(reshape(sentences[sentences.length-1]));
        ...
        public static String[] reshapeText(String[] input, boolean reshape)
        {
        	...
        	if(input != null)
        	{
        		for(int i=0;i<input.length;i++)
        			input[i]=(String)reshape(input[i]);
        		return input;
        	}
        	return null;
        }
