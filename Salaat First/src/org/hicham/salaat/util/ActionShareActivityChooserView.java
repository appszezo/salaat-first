 ...
 * @hide
 */
public class ActionShareActivityChooserView extends ActivityChooserView implements
    ...
    private int mDefaultActionButtonContentDescription;
         ...
         */
        public ActionShareActivityChooserView(Context context) {
            this(context, null);
    }
     ...
     */
    public ActionShareActivityChooserView(Context context, AttributeSet attrs) {
     ...
     */
    public ActionShareActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private ListPopupWindow getListPopupWindow() {
        if (mListPopupWindow == null) {
            ...
            mListPopupWindow.setAnchorView(ActionShareActivityChooserView.this);
