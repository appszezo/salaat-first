package org.hicham.salaat.settings.timepicker;
...
import org.holoeverywhere.widget.NumberPicker.NumberPickerEditText;
...
public class TimePicker extends FrameLayout {
    ...
    private void setContentDescriptions() {
        TimePicker.setContentDescription(mMinuteSpinner, R.id.increment,
                R.string.number_picker_increment_button);
        TimePicker.setContentDescription(mMinuteSpinner, R.id.decrement,
                R.string.number_picker_decrement_button);
