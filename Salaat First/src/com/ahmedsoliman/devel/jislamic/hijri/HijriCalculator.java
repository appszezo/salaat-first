 ...
 * <p>
 * The content of this class is copied and modified from the original source (in
 * C). I don't if there's some mistake when adapting it to Java, I hope no
 * mistake.
 */
class HijriCalculator {
	...
	static final class sDate {
		...
		// */
		// String frm_mname_sh; /* Converting from - Name of month in short
		// format */
	...
	private static int g_absolute(int day, int month, int year) {
	...
	/*
	 * Determine Gregorian date from passed-in Hijri/Islamic day/month/year ie.
	 * Hijri -> Gregorian
	 */
	static void g_date(sDate cdate, int day, int month, int year) {
		int abs_date;
		int pre_epoch = 0;
	...
	static int g_numdays(int month, int year) {
		int y;
	...
	private static int h_absolute(int day, int month, int year) {
	...
	/*
	 * Determine Hijri/Islamic date from passed-in Gregorian day/month/year ie.
	 * Gregorian -> Hijri
	 */
	static void h_date(sDate cdate, int day, int month, int year) {
		int abs_date;
		int pre_epoch = 0;
	...
	private static int h_leapyear(int year) {
	...
	static int h_numdays(int month, int year) {
