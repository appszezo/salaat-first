...
public class Rounding {
	...
	/**
	 * Normal Rounding. If seconds are equal to 30 or above, add 1 minute. Sets
	 * "Prayer.seconds" to zero.
	 */
	public static final Rounding NORMAL = new Rounding();

	/**
	 * Special Rounding. Similar to normal rounding but we always round down for
	 * Shurooq and Imsaak times. (default)
	 */
