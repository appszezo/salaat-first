 ...
 * Astro functions
 * 
 * Most of the astronomical values and formulas used in this file are based on
 * the Jean Meeus subset of the VSOP87 planetary theory.
 * 
 */
public class AstroLib {
	...
	public static double getRefraction(final Location loc, double sunAlt) {
		...
		part2 = 1.02 / (Utils.RAD_TO_DEG(Math.tan(Utils.DEG_TO_RAD(sunAlt
